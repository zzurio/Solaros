...
import club.cpacket.solaros.api.setting.Register;
...
import club.cpacket.solaros.manager.client.AnimationManager;
...
public class Module extends Register implements IGlobals {
    ...
    protected void onEnable() {
        ...
        Solaros.EVENT_BUS.register(this);
    }

    protected void onDisable() {
        animation.setState(false);
        MinecraftForge.EVENT_BUS.unregister(this);
        Solaros.EVENT_BUS.unregister(this);
    }
    ...
    public void setListener() {
        if (Solaros.INSTANCE.moduleManager.getModuleByClass(Notifications.class).isEnabled() && Solaros.INSTANCE.moduleManager.getModuleByClass(Notifications.class).modules.getValue()) {

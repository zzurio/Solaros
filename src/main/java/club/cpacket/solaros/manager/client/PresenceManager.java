...
public class PresenceManager implements IGlobals {
    ...
    public static void start() {
        ...
        handlers.ready = (user) -> System.out.println("[Solaros] RPC Started!");
        lib.Discord_Initialize("922967411739721808", handlers, true, "");

        presence.startTimestamp = System.currentTimeMillis() / 1000;
        presence.details = Solaros.INSTANCE.moduleManager.getModuleByClass(RPC.class).details.getValue();
        presence.state = "";
        presence.largeImageKey = "solaros";
        presence.largeImageText = Solaros.INSTANCE.moduleManager.getModuleByClass(RPC.class).largeImageText.getValue();
            ...
            while (!Thread.currentThread().isInterrupted()) {
                ...
                if (mc.world == null) {
                    ...
                    if (mc.currentScreen instanceof GuiWorldSelection) {
                        ...
                        presence.state = "Owning with Solaros.";
                    }
                } else {
                    if (mc.player != null) {
                        ...
                        if (mc.isIntegratedServerRunning()) {
                            ...
                            if (Solaros.INSTANCE.moduleManager.getModuleByClass(RPC.class).showIP.getValue()) {

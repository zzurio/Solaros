package club.cpacket.solaros.gui.theme;
...
public class SolarosTheme extends ThemeBase {
     ...
     */
    public SolarosTheme(IColorScheme scheme, int height, int padding, int border, int scroll, IntSupplier gradient) {
        super(scheme);
        this.height = height;
    ...
    public IContainerRenderer getContainerRenderer(int logicalLevel, int graphicalLevel, boolean horizontal) {
        return new IContainerRenderer() {
            ...
            public void renderBackground(Context context, boolean focus) {
                if (graphicalLevel == 0) SolarosTheme.this.renderBackground(context, focus);
            }
            ...
            public void renderButton(Context context, String title, boolean focus, T state) {
                ...
                if (graphicalLevel <= 0) {
                    if (container) {
                        ...
                        int gradient = SolarosTheme.this.gradient.getAsInt();
                        ITheme.drawRect(context.getInterface(), rect, colorA);
    ...
    public IColorPickerRenderer getColorPickerRenderer() {
        return new StandardColorPicker() {
            ...
            public int getBaseHeight() {
                return SolarosTheme.this.getBaseHeight();
            }
        };
    }

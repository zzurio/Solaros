package club.cpacket.solaros.gui.panelstudio;
...
import club.cpacket.solaros.api.setting.settings.Bind;
import club.cpacket.solaros.api.setting.settings.ColorPicker;
import club.cpacket.solaros.gui.theme.SolarosTheme;
...
public class PanelStudioGUI extends MinecraftGUI {
    ...
    public PanelStudioGUI() {
        ...
        // Instantiating theme ...
        ITheme theme = new OptimizedTheme(new SolarosTheme(new IColorScheme() {
            @Override
            public void createSetting(ITheme theme, String name, String description, boolean hasAlpha, boolean allowsRainbow, Color color, boolean rainbow) {
                ClickGUI.clickGUI.register(new Setting<ColorPicker>(name, description, new ColorPicker(color)));
            }

            @Override
            public Color getColor(String name) {
                return ((Setting<ColorPicker>) ClickGUI.clickGUI.getSetting(name)).getValue().getColor();
            }
    ...
    private ISetting<?> getSetting(Module module, Setting<?> setting) {
        ...
        else if (setting.getValue() instanceof ColorPicker)
            return new IColorSetting() {
                @Override
                public Color getValue() {
                    return ((ColorPicker) setting.getValue()).getColor();
                }

                @Override
                public Color getColor() {
                    return ((ColorPicker) setting.getValue()).getRawColor();
                }

                @Override
                public boolean getRainbow() {
                    return ((ColorPicker) setting.getValue()).isRGB();
                }
                ...
                public void setRainbow(boolean rainbow) {
                    if (rainbow) ((ColorPicker) setting.getValue()).setRGB();
                    else ((ColorPicker) setting.getValue()).unsetRGB();
                }
